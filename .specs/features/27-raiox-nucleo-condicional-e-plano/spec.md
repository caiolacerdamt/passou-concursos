# SPEC 27 — Raio-X: amortecimento, núcleo × condicional e integração com o plano

| | |
| --- | --- |
| **Ordem** | 27 de 42 · [ROADMAP](../../ROADMAP.md) |
| **Depende de** | SPEC 06, SPEC 26 |
| **Habilita** | SPEC 28, 34, 38; e a fila da base de referência da SPEC 13 |
| **Tasks (estimativa)** | ~10 |
| **Dificuldade** | Difícil |
| **Status** | ⬜ Não iniciada |
...
- [ ] A fila da base de referência (SPEC 13) sai ordenada por frequência real amortecida.
...
| O que | Onde entra |
| --- | --- |
| Registro e curadoria do empurrão de atualidade, validade, tela | SPEC 34 (aqui entra o **teto** e como o empurrão entra na conta) |
| Diff do edital | SPEC 34 |
| Módulo de formato A–E × Certo/Errado | SPEC 38 |
...
- O teto do empurrão **não é contornável pela tela** (SPEC 34).
