# SPEC 41 — Grupo 3: sequência pseudonimizada

| | |
| --- | --- |
| **Ordem** | 41 de 42 · [ROADMAP](../../ROADMAP.md) · **fast-follow** |
| **Depende de** | SPEC 32, SPEC 35 |
| **Tasks (estimativa)** | ~7 |
| **Dificuldade** | Média |
| **Status** | ⬜ Não iniciada |
| **Requisitos** | **DADOS-13** |
...
| --- | --- | --- |
| DADOS-13 | tabela de sequência por código, correspondência separada, acesso restrito, opt-out respeitado, extensão da rotina de esquecimento da SPEC 32 **na mesma task** | §P3: Grupo 3 |
