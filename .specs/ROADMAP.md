...
| 12 | **Checkout, funil e ativação** | página de vendas, Asaas cartão/Pix/boleto, webhook verificado e idempotente, reconciliação, garantia de 7 dias, 18+ | 07 | 12 | **A** | 🔄 Em homologação — implementada e mergeada; 1 defeito aberto (estorno de parcelamento) |
