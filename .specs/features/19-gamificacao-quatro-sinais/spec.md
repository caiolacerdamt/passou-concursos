# SPEC 19 — Gamificação: os quatro sinais

| | |
| --- | --- |
| **Ordem** | 19 de 36 · [ROADMAP](../../ROADMAP.md) · pós-lançamento |
...
> **Nota da AD-089.** O sinal "no prazo" lê `data_prova` de `perfil_concurso`, que passou para a
> SPEC 11 — por isso a dependência é dela, não do núcleo × condicional da SPEC 20.
...
| O que | Onde entra |
| --- | --- |
| Escudos, reset suave, janela de recuperação, notificação | SPEC 26 |
| Grupo privado de responsabilidade | SPEC 26 (P3) |
