# SPEC 35 — Flywheel: esteiras 1 e 2

| | |
| --- | --- |
| **Ordem** | 35 de 42 · [ROADMAP](../../ROADMAP.md) · **fast-follow** |
| **Depende de** | SPEC 18, SPEC 30, SPEC 31 (base legal e LIA antes de ligar) |
| **Tasks (estimativa)** | ~11 |
| **Dificuldade** | Difícil |
| **Status** | ⬜ Não iniciada |
...
| O que | Onde entra |
| --- | --- |
| Grupo 2 e piso de anonimato | SPEC 30 |
| Opt-out e LIA | SPEC 31 — **o flywheel não liga antes do LIA arquivado** |
| Grupo 3 / knowledge tracing | SPEC 41 |
