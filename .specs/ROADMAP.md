...
| 05 | Log de tentativas | `tentativas` particionada, snapshot congelado, trava de 3 camadas, RLS, `registrarTentativa` | 04 | 8 | **A** | 🟨 Design e tasks prontos (T11–T15) |
...
**Restam ~107 tasks em 10 specs** para lançar.
