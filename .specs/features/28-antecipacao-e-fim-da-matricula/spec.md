# SPEC 28 — Garantia, antecipação e fim da matrícula

| | |
| --- | --- |
| **Ordem** | 28 de 36 · [ROADMAP](../../ROADMAP.md) · pós-lançamento |
| **Depende de** | SPEC 12 |
| **Habilita** | SPEC 18 (o relógio de retenção começa no fim da matrícula), 34 |
| **Tasks (estimativa)** | ~9 |
...
| O que | Onde entra |
| --- | --- |
| DELETE dos dados do aluno | SPEC 18 — reembolso **não** apaga histórico; são pedidos distintos |
...
- Avisos de vencimento são **transacionais** — não dependem do consentimento de marketing (SPEC 17).
