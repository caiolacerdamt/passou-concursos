# SPEC 18 — Painel do operador

| | |
| --- | --- |
| **Ordem** | 18 de 42 · [ROADMAP](../../ROADMAP.md) |
| **Depende de** | SPEC 10, SPEC 17 |
| **Habilita** | SPEC 34, 35 (as telas de curadoria delas herdam este painel) |
| **Tasks (estimativa)** | ~10 |
| **Dificuldade** | Média |
| **Status** | ⬜ Não iniciada |
...
| Curadoria de atualidade do Raio-X | SPEC 34 |
| Revisão em lote das questões suspeitas do flywheel | SPEC 35 |
| Trilha de auditoria da LGPD | SPEC 30 (esta tela **vira consumidora** dela depois) |
