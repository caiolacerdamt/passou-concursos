# SPEC 22 — Verificação quantitativa por catálogo de fórmulas

| | |
| --- | --- |
| **Ordem** | 22 de 36 · [ROADMAP](../../ROADMAP.md) · pós-lançamento |
...
| O que | Onde entra |
| --- | --- |
| Texto da explicação em si | SPEC 10 (aqui só o número é conferido) |
...
- A SPEC 10 **não publica** explicação quantitativa sem o veredito daqui.
