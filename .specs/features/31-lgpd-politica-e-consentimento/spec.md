# SPEC 31 — LGPD: política, base legal e consentimento

| | |
| --- | --- |
| **Ordem** | 31 de 42 · [ROADMAP](../../ROADMAP.md) |
| **Depende de** | SPEC 19, SPEC 30 |
| **Habilita** | SPEC 32, 33 (notificação fora do app exige consentimento), 35 |
| **Tasks (estimativa)** | ~8 |
| **Dificuldade** | Média |
| **Status** | ⬜ Não iniciada |
...
| DADOS-11 (parte) | termos e política declarando serviço para maiores de 18 (a declaração no checkout é da SPEC 19) | §P1: Declaração de maioridade |

## Out of Scope

| O que | Onde entra |
| --- | --- |
| Classificação de grupos, RLS, auditoria | SPEC 30 |
| Esquecimento, retenção, exportação, correção | SPEC 32 |
| Esteiras do flywheel | SPEC 35 (esta spec entrega a base legal e o opt-out que elas respeitam) |
...
- Notificação fora do app (SPEC 33) só sai com consentimento; aviso dentro do produto, não.
