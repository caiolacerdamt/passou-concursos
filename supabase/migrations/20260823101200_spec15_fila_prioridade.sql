-- SPEC 15 · segunda correcao forward-only de T119
-- A prioridade da fila e smallint; o literal precisa declarar o mesmo tipo
-- para a resolucao encontrar a funcao existente sem conversao implicita.
