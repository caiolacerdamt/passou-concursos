# SPEC 32 — LGPD: esquecimento, retenção e canal do titular

| | |
| --- | --- |
| **Ordem** | 32 de 42 · [ROADMAP](../../ROADMAP.md) · **última spec antes do lançamento** |
| **Depende de** | SPEC 30, SPEC 31 |
| **Habilita** | SPEC 41 |
| **Tasks (estimativa)** | ~12 |
| **Dificuldade** | Difícil |
| **Status** | ⬜ Não iniciada |
...
⚠️ **Regra permanente:** toda spec posterior que criar dado do grupo 1 (SPEC 33, 41 e o que vier)
...
| O que | Onde entra |
| --- | --- |
| Base legal, política, consentimento | SPEC 31 |
| Grupo 3 pseudonimizado | SPEC 41 (quando existir, some no DELETE junto com a correspondência) |
| Reembolso | SPEC 20 — DELETE e reembolso são pedidos distintos; reembolso primeiro |
