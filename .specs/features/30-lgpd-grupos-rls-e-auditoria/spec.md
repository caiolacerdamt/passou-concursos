# SPEC 30 — LGPD: grupos de dado, RLS e auditoria

| | |
| --- | --- |
| **Ordem** | 30 de 42 · [ROADMAP](../../ROADMAP.md) |
| **Depende de** | SPEC 05, SPEC 19, SPEC 28, SPEC 29 |
| **Habilita** | SPEC 31, 32, 35, 41 |
| **Tasks (estimativa)** | ~10 |
| **Dificuldade** | Média |
| **Status** | ⬜ Não iniciada |
...
| O que | Onde entra |
| --- | --- |
| Política de privacidade, base legal, consentimento, opt-out | SPEC 31 |
| DELETE, retenção, exportação, correção | SPEC 32 |
| Esteiras do flywheel que **leem** o grupo 2 | SPEC 35 |
| Grupo 3 pseudonimizado | SPEC 41 |
