# SPEC 39 — Áudio: fábrica de voz

| | |
| --- | --- |
| **Ordem** | 39 de 42 · [ROADMAP](../../ROADMAP.md) · **fast-follow** |
| **Depende de** | SPEC 14, SPEC 30 |
| **Tasks (estimativa)** | ~11 |
| **Dificuldade** | Difícil |
...
| O que | Onde entra |
| --- | --- |
| Escopo por frequência, teto de gasto, provedor reserva, controles de escuta | SPEC 40 |
| Áudio ao vivo | **nunca** (invariante nº7) |

## Contrato herdado

Quando a explicação é invalidada (SPEC 14), **o áudio daquela versão é descartado e refeito**
(TTS-04/AD-014).
