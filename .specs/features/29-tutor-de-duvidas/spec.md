# SPEC 29 — Tutor de dúvidas

| | |
| --- | --- |
| **Ordem** | 29 de 42 · [ROADMAP](../../ROADMAP.md) |
| **Depende de** | SPEC 07, SPEC 13, SPEC 22 |
| **Habilita** | — |
| **Tasks (estimativa)** | ~11 |
| **Dificuldade** | Difícil |
| **Status** | ⬜ Não iniciada |
...
| IA-12 (consumo) | o alerta de gasto criado na SPEC 07 passa a ter volume de verdade; **não** desliga o tutor sozinho | m2 §P1: Tutor (AC6) |

## Out of Scope

| O que | Onde entra |
| --- | --- |
| Gateway, matriz de modelos, fallback | SPEC 07 |
| Explicação e fontes | SPEC 13 |
