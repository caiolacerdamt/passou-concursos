# SPEC 37 — Questões inéditas

| | |
| --- | --- |
| **Ordem** | 37 de 42 · [ROADMAP](../../ROADMAP.md) · **fast-follow** |
| **Depende de** | SPEC 10, SPEC 26 |
| **Tasks (estimativa)** | ~9 |
| **Dificuldade** | Média |
| **Status** | ⬜ Não iniciada |
| **Requisitos** | **BANCO-08** |
...
| --- | --- | --- |
| BANCO-08 | tarefa de rascunho no gateway, etiquetagem, revisão obrigatória, verificação quantitativa quando for de conta (SPEC 12) | §P2: Geração de inéditas |
