...
/** O mesmo desenho de Hoje sem o cartão do dia — o Plano não traz gamificação. */
export default function CarregandoPlano() {
  return (
    <Carregando rotulo="Carregando o ciclo do edital">
