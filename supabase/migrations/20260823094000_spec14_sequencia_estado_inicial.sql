-- SPEC 14 · GAM-02 · estado inicial sem histórico
--
-- Complementa a migration anterior: uma consulta sem linha histórica precisa
-- devolver zero, não NULL, mantendo o contrato do estado inicial.
...
comment on function public.consultar_sequencia_do_dia() is
  'Calcula o anel de hoje a partir da última data histórica, com zero explícito no estado inicial, sem user_id recebido do cliente e sem gravar estado (GAM-02/AD-071).';
