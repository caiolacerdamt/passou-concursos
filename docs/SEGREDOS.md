...
| `RESEND_API_KEY` | **sim** | ✅ | ✅ | Vercel / Supabase / **Actions** | confirmação do apagamento (SPEC 14) **e os quatro e-mails do trial** (AD-133) |
| `RESEND_FROM` | não (configuração) | ✅ | ✅ | Vercel / Supabase / **Actions** | remetente verificado dos e-mails de privacidade e do trial |
