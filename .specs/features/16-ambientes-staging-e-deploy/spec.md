# SPEC 16 — Ambientes, staging e deploy

| | |
| --- | --- |
| **Ordem** | 16 de 42 · [ROADMAP](../../ROADMAP.md) |
| **Depende de** | SPEC 03, SPEC 15 |
| **Habilita** | SPEC 17, 19 (o webhook do Asaas precisa de URL pública), 21 |
| **Tasks (estimativa)** | ~8 |
| **Dificuldade** | Média |
| **Status** | ⬜ Não iniciada |
...
A partir da SPEC 19 existe um webhook de pagamento: alguém paga e o dinheiro chega a um endpoint que
...
| O que | Onde entra |
| --- | --- |
| Vercel **Pro** e streaming | SPEC 29 (só o tutor exige o Pro — AD-066) |
| Sentry, alertas, segredos no código | SPEC 03 |
| Analytics e proxy reverso | SPEC 21 |
...
| Plano Vercel | Hobby basta até o tutor entrar (SPEC 29) | y (AD-066) |
